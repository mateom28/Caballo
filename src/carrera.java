...
public class carrera {
    ...
    static public void registrarCaballos(){
        ...
        //nombres
        losCaballos[0].setNombre("Iron horse");
        losCaballos[1].setNombre("Ben 10");
        losCaballos[2].setNombre("Reese");
        losCaballos[3].setNombre("Joshua");
        losCaballos[4].setNombre("Rayo mcqueen");
        losCaballos[5].setNombre("Jason funderburker");
        losCaballos[6].setNombre("Thor");
        losCaballos[7].setNombre("Spidey");
        losCaballos[8].setNombre("Black widow");
        losCaballos[9].setNombre("Vegeta");
        //CoordX
